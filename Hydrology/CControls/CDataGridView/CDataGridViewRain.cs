...
namespace Hydrology.CControls
{
    ...
    class CDataGridViewRain : CExDataGridView
    {
        ...
        public static readonly string CS_shfx = "瞬时风向";
        public static readonly string CS_shfs = "瞬时风速";
        public static readonly string CS_yxszdshfx = "一小时最大瞬时风向";
        public static readonly string CS_yxszdshfs = "一小时最大瞬时风速";
        public static readonly string CS_maxTime = "最大风速时间";
        public static readonly string CS_avg2fx = "2分钟平均风向";
        public static readonly string CS_avg2fs = "2分钟平均风速";
        public static readonly string CS_avg10fx = "10分钟平均风向";
        public static readonly string CS_avg10fs = "10分钟平均风速";
        public static readonly string max10fx = "10分钟最大风向";
        public static readonly string max10fs = "10分钟最大风速";
        public static readonly string max10tm = "10分钟最大风速时间";
            ...
            : base()
        {
            ...
            {
                CS_StationID,CS_StationName,CS_TimeCollected,
                CS_shfx ,CS_shfs , CS_yxszdshfx ,
                CS_yxszdshfs,CS_DataState,CS_avg10fx , CS_avg10fs
            };
        ...
        public void InitDataSource(IFSFXProxy proxy)
        {
            m_proxyFsfx = proxy;
        }
        ...
        public bool SetFilter(string iStationId, DateTime timeStart, DateTime timeEnd, bool TimeSelect)
        {
            ...
            m_proxyFsfx.SetFilter(iStationId, timeStart, timeEnd, TimeSelect);
            if (-1 == m_proxyFsfx.GetPageCount())
            {
                // 查询失败
            ...
            else
            {
                ...
                SetRain(m_proxyFsfx.GetPageData(1));
                return true;
            }
        }
        ...
        protected override void OnMenuPreviousPage(object sender, EventArgs e)
        {
            ...
            if (this.IsModifiedUnSaved())
            {
                ...
                else if (DialogResult.Yes == result)
                {
                    ...
                    // 保存成功，换页
                    SetRain(m_proxyFsfx.GetPageData(base.m_iCurrentPage - 1));
        ...
        protected override void OnMenuFirstPage(object sender, EventArgs e)
        {
            if (this.IsModifiedUnSaved())
            {
                ...
                else if (DialogResult.Yes == result)
                {
                    ...
                    SetRain(m_proxyFsfx.GetPageData(base.m_iCurrentPage));
                    this.UpdateDataToUI();
                }
                else if (DialogResult.No == result)
                {
