...
namespace Hydrology.CControls
{
    ...
    class CDataGridViewRTD : CExDataGridView
    {
        ...
        public static readonly string CS_Visi1min = "1分钟能见度";
        public static readonly string CS_Visi10min = "10分钟能见度";
        public static readonly string CS_Depth = "深度";
        public static readonly string CS_Tmp = "温度";
        public static readonly string CS_Ntu = "浊度";
        public static readonly string CS_Cndcty = "电导率";
        ...
        public void RecalculateHeaderSize()
        {
            ...
            this.Columns[2].Width = 180; //删除列宽度为20
