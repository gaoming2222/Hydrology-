...
namespace Hydrology.Forms
{
    public partial class CStationDataMgrForm : Form
    {
        ...
        private static readonly string CS_CMB_FsfxData = "风速风向数据";
        private static readonly string CS_CMB_ObsData = "浊度数据";
        private static readonly string CS_CMB_PwdData = "能见度数据";
        private static readonly string CS_CMB_Water = "水位数据";
        ...
        private void InitUI()
        {
            ...
            // 初始化查询信息类型
            this.SuspendLayout();
            cmbQueryInfo.Items.AddRange(new string[] { CS_CMB_FsfxData, CS_CMB_ObsData,CS_CMB_PwdData,CS_CMB_Water });
            ...
            m_dgvRain.RowHeadersWidth = 7;
            m_dgvRain.ColumnHeadersHeight = 50;
            m_dgvRain.Margin = new System.Windows.Forms.Padding(0, 0, 3, 0);
            //m_dgvRain.Rows[0].Height = 20
            //m_dgvRain.Dock = DockStyle.Fill;
            ...
            m_dgvWater.RowHeadersWidth = 7;
            m_dgvWater.ColumnHeadersHeight = 50;
            ...
            m_dgvVoltage.RowHeadersWidth = 7;
            m_dgvVoltage.ColumnHeadersHeight = 50;
            ...
            m_dgvSoilData.RowHeadersWidth = 7;
            m_dgvSoilData.ColumnHeadersHeight = 50;
        ...
        {
            // 更改选项
            if (cmbQueryInfo.Text.Equals(CS_CMB_FsfxData))
            {
                //查询雨量
                //tLayoutRight.Controls.Add(m_dgvRain, 0, 0);
                m_dgvRain.Show();
            ...
            else if (cmbQueryInfo.Text.Equals(CS_CMB_PwdData))
            {
                //查询电压
                m_dgvRain.Hide();
                m_dgvWater.Hide();
            ...
            else if (cmbQueryInfo.Text.Equals(CS_CMB_ObsData))
            {
                //查询墒情数据
                m_dgvRain.Hide();
                m_dgvWater.Hide();
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                #region OBS浊度信息
                if (m_dgvSoilData.SetFilter(stationId, dtpTimeStart.Value, dptTimeEnd.Value, TimeSelect))
                {
                    m_charSoilData.SetFilter(stationId, dtpTimeStart.Value, dptTimeEnd.Value);
                }
